...
const YoutubeCommentsHeroSection: React.FC = () => {
      ...
      <div className="grid lg:grid-cols-2 gap-10 items-center">
        <motion.div className="flex flex-col gap-2" initial="hidden" animate={isVisible ? "visible" : "hidden"} variants={fadeIn} transition={{ duration: 0.5 }}>
          ...
          <motion.p className="text-lg text-gray-600 mb-4" variants={fadeIn} transition={{ delay: 0.3 }}>
            Give wings to your YouTube videos with high quality YouTube Comments that no YouTube algorithm can suspect. Because, they are from real people! Experience the doping effect of the right audience with a reasonable price with BuyRealViews.
          </motion.p>
        ...
        <DynamicPackageSelector serviceType="youtube_comments" categoryName="YouTube Comments" title="Buy YouTube Comments" />
      </div>
    </section>
  );
};

export default YoutubeCommentsHeroSection;
