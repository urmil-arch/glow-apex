...
const YoutubeViewsHeroSection: React.FC = () => {
  ...
  //       { amount: 250, price: "7.99", discount: 5 },
  //       { amount: 500, price: "12.99", discount: 10 },
  //       { amount: 1000, price: "19.99", discount: 15 },
  //     ],
  //   },
  //   active: {
  //     name: "Active Views",
  //     quantities: [
  //       { amount: 100, price: "4.99", discount: 0 },
  //       { amount: 250, price: "9.99", discount: 5 },
  //       { amount: 500, price: "16.99", discount: 10 },
  //       { amount: 1000, price: "24.99", discount: 15 },
  //     ],
  //   },
  // };
      ...
      <div className="grid lg:grid-cols-2 gap-10 items-center">
        ...
        >
          ...
          >
            ...
            <motion.button
              onClick={() => {
                setCategoryOrder({ categoryName: "YouTube Views", quantity: selectedQuantity });
                navigate("/checkout");
              }}
