...
import {
  whyBuyYouTubeShortsLikesData,
  youtubeShortsLikesFaqData,
} from "@/config/data";
    ...
    <div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="flex flex-col gap-4">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold capitalize mb-3">
              Get Real YouTube Shorts Likes
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-emerald-500">
                Fast & Authentic
              </span>
            </h1>
            <p className="text-lg text-gray-600 mb-4">
              Boost your Shorts engagement with high-quality YouTube likes from real users. Improve your rankings and visibility to get more organic traffic.
            </p>
      ...
      <div className="sm:mb-32 mb-20 bg-gradient-to-b to-transparent from-[#0eca6d] w-full rounded-3xl sm:pt-44">
        <section className="container p-16">
          <SectionHeader
            tabHeading="why"
            title="Why Buy YouTube Shorts Likes from buyrealviews.com?"
          />
          <div className="mt-22 grid grid-rows-3 gap-4 relative">
            <div className="bg-white rounded-3xl p-5 flex items-center justify-start gap-4 md:w-fit w-full md:mx-0 mx-auto">
              ...
              <div>
                ...
                <p className="text-lg">Real likes, no bots, no risk.</p>
              </div>
            </div>
            <img
            ...
            <div className="bg-white rounded-3xl p-5 flex items-center justify-start gap-4 md:w-fit w-full mx-auto z-10 lg">
              ...
              <div>
                <h3 className="text-2xl font-semibold">Instant Results</h3>
                <p className="text-lg">See your engagement grow quickly.</p>
              </div>
            </div>
            <img
              src={"/assets/illustration/down-arrow.svg"}
            ...
            <div className="bg-white rounded-3xl p-5 flex items-center justify-start gap-4 md:w-fit w-full md:ml-auto md:mx-0 mx-auto">
              ...
              <div>
                <h3 className="text-2xl font-semibold">Algorithm Boost</h3>
                <p className="text-lg">Improve your visibility on YouTube.</p>
              </div>
            </div>
          </div>
        </section>
      ...
      {/* Feature Section */}
      <FeatureSection data={whyBuyYouTubeShortsLikesData} />
...
export default YoutubeShortsLikes;
