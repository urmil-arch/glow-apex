...
const YoutubeSubscribersHeroSection: React.FC = () => {
  ...
  // Prices are in USD
 const packages: PackagesData = servicesPackages.subscribers;
  ...
  const features: string[] = [
    ...
    useEffect(() => {
      const firstQuantity =
        servicesPackages["subscribers"][selectedPackage].quantities[0].amount;
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-gray-600">
              <span className="font-bold text-black">1,250+</span> creators
              boosted their channels in the last 24 hours
            </p>
          </motion.div>
        </motion.div>
        ...
        >
          ...
          <motion.div className="text-center relative z-10" variants={fadeIn}>
            ...
            <p className="text-lg mt-2 text-gray-600">
              Select a package that matches your growth goals
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            transition={{ delay: 0.3 }}
          >
            {Object.keys(servicesPackages["subscribers"]).map((packageType) => {
              return (
                <motion.button
                  key={packageType}
                  ...
                  whileTap={{ y: 0 }}
                >
                  {servicesPackages["subscribers"][packageType].name}
                </motion.button>
              );
            })}
          </motion.div>
          ...
          >
            ...
            <motion.button
              onClick={() => {
                setCategoryOrder({ categoryName: "YouTube Subscribers", quantity: selectedQuantity });
                navigate("/checkout");
              }}
            ...
            <motion.div
              className="flex flex-wrap items-center justify-center gap-4 mt-4 text-sm text-gray-500"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 1 }}
            >
