...
const AllBlogsPage = () => {
  ...
  const fetchPosts = useCallback(async () => {
    setLoading(true);
    try {
      const res = await api.get<{ posts: BlogPost[]; total: number }>(API_ENDPOINTS.PUBLIC_BLOGS, {
    ...
    <div className="pt-32 pb-24">
      ...
      <div className="container mb-16">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Blog & Resources</h1>
      ...
      <div className="container mb-12">
        <div className="flex flex-col md:flex-row gap-6 items-center justify-between">
          <div className="relative w-full md:w-80">
            ...
            />
            <svg className="absolute right-3 top-3.5 text-muted-foreground" width="18" height="18"
                ...
                <Link to={`/blogs/${post.slug}`} className="block">
                  <div className="h-48 bg-emerald-50 relative overflow-hidden flex items-center justify-center">
                    {post.image_url ? (
                      ...
                      <div className="w-16 h-16 rounded-2xl bg-emerald-200 flex items-center justify-center text-emerald-700 text-3xl font-bold">
                        {post.title.charAt(0)}
                      </div>
                    )}
        ...
        <div className="bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-3xl p-8 md:p-12">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto">
              <input type="email" placeholder="Your email address" className="flex-1 px-4 py-3 rounded-xl bg-gray-100 focus:outline-none" />
