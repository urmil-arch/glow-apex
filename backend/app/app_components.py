...
from app.admin.service_packages.router import router as service_packages_router
...
def include_routers(app: FastAPI) -> None:
    ...
    app.include_router(service_packages_router, prefix="/admin/service-packages", tags=["Service Packages"])
