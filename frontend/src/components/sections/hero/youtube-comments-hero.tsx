...
const YoutubeCommentsHeroSection: React.FC = () => {
  ...
  // Prices are in USD
 const packages: PackagesData = servicesPackages.comments;
  ...
  const features: string[] = [
    ...
    useEffect(() => {
      const firstQuantity =
        servicesPackages["comments"][selectedPackage].quantities[0].amount;
    ...
    <section className="container mx-auto px-4 pb-12 lg:pb-20 pt-44">
      <div className="grid lg:grid-cols-2 gap-10 items-center">
        ...
        >
          ...
          >
            Give wings to your YouTube videos with high quality YouTube Comments
        ...
        >
          ...
          <motion.div
            ...
            transition={{ delay: 0.3 }}
          >
            {Object.keys(servicesPackages["comments"]).map((packageType) => {
              return (
                <motion.button
                  key={packageType}
                  ...
                  whileTap={{ y: 0 }}
                >
                  {servicesPackages["comments"][packageType].name}
                </motion.button>
              );
            })}
          </motion.div>
          ...
          >
            ...
            <motion.button
              onClick={() => {
                setCategoryOrder({ categoryName: "YouTube Comments", quantity: selectedQuantity });
                navigate("/checkout");
              }}
